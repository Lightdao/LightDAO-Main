...
const AccountSettingsWalletOnePageNotifications: React.FC<ChangePageProps> = ({
  ...
  return (
    <div className="wallet-settings-page">
      ...
      <div className="tabs">
        ...
        <button
          onClick={() => changeSettingsPageHandler(2)}
        ...
        {preferences.map((pref) => (
          <div key={pref.key} className="wallet-settings-preference-item">
            <div className="wallet-settings-preference-labels">
              <span className="wallet-settings-preference-subtitle">
                {pref.label}
              </span>
              <span className="wallet-settings-preference-title">
                {pref.description}
              </span>
            </div>
            <div
