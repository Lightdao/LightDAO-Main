...
async function mintNFT(selectedImage: File | null, data: NftMetaData) {
  ...
  console.log(
    "Mint result link: https://solana.fm/tx/" +
      base58.deserialize(sigArray)[0] +
...
const NewListingsStep7: React.FC<ImageData> = ({
  selectedImage,
  imagePreviewUrl,
  data,
}) => {
  return (
    <div className="step7-container">
      ...
      {/* Publish Button */}
      <button
        onClick={() => mintNFT(selectedImage, data)}
