...
const AccountSettingsProfileOnePage: React.FC<ChangePageProps> = ({
  changeSettingsPageHandler,
}) => {
  return (
    <div className="account-settings-profile">
      ...
      <div className="tabs">
        <button
          onClick={() => changeSettingsPageHandler(0)}
          className="tab active"
        >
          Profile
        </button>
        <button onClick={() => changeSettingsPageHandler(1)} className="tab">
          Wallet
        </button>
        <button onClick={() => changeSettingsPageHandler(2)} className="tab">
          Notifications
        </button>
      </div>
      ...
      <form className="account-form">
        <label>
          Email
          <input type="email" placeholder="e.g. Please provide your email" />
        </label>
        <label>
          Username*
          <input type="text" placeholder="e.g. Please pick your username" />
        </label>
        <label>
          Link*
          <input type="text" placeholder="e.g. Please provide a link name" />
        </label>
        <label>
          Add a bio
          <input type="text" placeholder="e.g. Please provide a link name" />
