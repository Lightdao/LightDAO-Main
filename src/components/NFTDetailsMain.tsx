...
const nftDetails = [{
  name: "Lion of Judah",
  img: "/Lion.png",
  description: "A collection of 10,000 unique NFTs minted on the Solana blockchain. Each unique artwork is randomly generated from a combination of traits.",
  price: "10.0",
    ...
    <>
      ...
      <div className="nft-auction-section">
        <div className="nft-price">
          ...
          <button className="nft-address">{nftDetails[Number(id)].address}</button>
        </div>
