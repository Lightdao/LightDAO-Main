    ...
    <div className="donor-00A">
      ...
      <div className="barpage">
        ...
        {ProjectSelected ? (
          <SpecificProject
            goBack={goBack}
            projectData={tableList[projectIndex]}
          />
        ) : (
          <ProjectDashboard projectButtonClick={projectButtonClick} />
        )}
      </div>
      <MainFooter />
    </div>
...
const ProjectDashboard: React.FC<ProjectFunction> = ({
  projectButtonClick,
}) => {
  return (
...
const Projects: React.FC<ProjectFunction> = ({ projectButtonClick }) => {
  const tableElements = tableList.map((item, index) => (
    <button
      onClick={() => projectButtonClick(index)}
    ...
    >
      ...
      <div className="cell">
        <div className="table-img">
          <img src={item.blockchain + ".svg"} alt="" />
        </div>
        <p>{item.blockchain}</p>
      </div>
      <div className="cell">
        <div className="profile-icon">
          <img src={item.ownerProfilePic} alt="" />
        </div>
        <p>{item.owner}</p>
      </div>
      <div className="cell">
  ...
  return <div className="table-body">{tableElements}</div>;
};
  ...
  return (
    <div className="project-navigation">
      <div className="quick-selection">
        ...
        <div className="central-buttons">
          <button
            ...
            className={current === 1 ? "selected" : "unselected"}
          >
            1
          </button>
          <button
            onClick={() => setCurrent(2)}
            className={current === 2 ? "selected" : "unselected"}
          >
            2
          </button>
          <button
            onClick={() => setCurrent(3)}
            className={current === 3 ? "selected" : "unselected"}
          >
            3
          </button>
          <button
            onClick={() => setCurrent(4)}
            className={current === 4 ? "selected" : "unselected"}
          >
            4
          </button>
          <button
            onClick={() => setCurrent(5)}
            className={current === 5 ? "selected" : "unselected"}
          >
            5
          </button>
        </div>
      ...
      <div className="amount-selection">
        <p>
          Showing {begin} to {begin + amountShown - 1} of {tableList.length} |
          Item Per Page:{" "}
        </p>
...
const SpecificProject: React.FC<SpecificProjectProps> = ({
  goBack,
  projectData,
}) => {
  ...
  return (
    <div className="project-dashboard specific-project">
      <section>
        <p>
          Donor - Home &gt; PROJECTS DASHBOARD &gt;{" "}
          {projectData.projectName.toUpperCase()} DETAILS
        </p>
        <div className="project-data">
          <div>
            <h1>{projectData.projectName}</h1>
            <p>
              By <span className="project-info">{projectData.owner}</span>{" "}
              Creation Date:{" "}
              <span className="project-info">{projectData.dateCreated}</span>{" "}
              Expiration Date:{" "}
              <span className="project-info">{projectData.expirationDate}</span>
            </p>
            <div className="project-funding">
              <p>Funding Goal: $200</p>
              <div className="project-data-goal round-corner-box">
                {projectData.goal}
              </div>
            ...
            <div className="project-categories">
              <p>Category: </p>
              <div className="project-category round-corner-box">
                Mobile App
              </div>
            </div>
          </div>
        ...
        <div className="project-description">
          <h5>Overview</h5>
          <p>
            "Tracking On The Go" is a cutting-edge mobile application designed
            to revolutionize how individuals monitor and manage their health. In
            today's fast-paced world, keeping track of calorie intake and burn
            rate can be a challenge. This app empowers users to take control of
            their fitness journey by providing an intuitive, user-friendly
            platform for tracking and analyzing their daily calorie metrics.
          </p>
          <h5>Purpose</h5>
          <p>
            The primary goal of this proposal is to develop an all-in-one
            calorie tracking app that integrates seamlessly into the daily lives
            of users. By leveraging modern technology, "Tracking On The Go" will
            enable users to make informed decisions about their nutrition and
            activity levels, leading to healthier lifestyles and better fitness
            outcomes.
          </p>
        </div>
        <h6>Attachments</h6>
        <div className="attachment-names-row">
          <ReturnAttachmentNames
            array={projectData.attachments}
      ...
      <section>
        <div className="project-action-buttons">
          <button onClick={goBack} className="back-button project-button">
            <img src="/Back Icon.svg" alt="back icon" />
            <p>GO BACK</p>
          </button>
          <div className="project-action-buttons">
            <button className="share-button project-button">
              <p>SHARE</p>
              <img src="/Share Icon.svg" alt="share arrow" />
            </button>
            <button
              onClick={openWindow}
              className="donate-button project-button"
            >
              <p>DONATE NOW</p>
              <img src="/Donate Icon.svg" alt="donate icon" />
            </button>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <p>
          Timely updates and correspondence of the active project by the Project
          Owner...
        </p>
        <div className="history-table">
          <div className="table-body">
            <div className="table-rows">
              ...
              <p className="cell">
                The prototype for the app is complete. Testing should begin next
                week
              </p>
              ...
              <div className="cell">
                ...
                <img
                  src="/Update Comments Icon.svg"
                  alt="update comments icon"
                />
              </div>
              <div className="cell">
                <img
                  className="right-turned-arrow"
                  src="/right-arrow.svg"
                  alt="down arrow"
                />
              </div>
            ...
            <div className="table-rows">
              ...
              <p className="cell">
                Fundraising has reached 70% of its target goal
              </p>
        ...
        <a className="see-update-link" href="">
          See more updates...
        </a>
      </section>
      ...
      <section>
        ...
        <div className="owner-profile">
          ...
          <div>
            ...
            <p>
              Date Joined: <span className="project-info">03rd May, 2024</span>
            </p>
          </div>
        </div>
        <div className="project-history">
          ...
          <div className="history-buttons">
            <button className="icon-button">
              <img src="Chart Icon.svg" alt="icon1" />
            </button>
            <button className="icon-button">
              <img src="Graph Icon.svg" alt="icon2" />
            </button>
          </div>
          <div className="project-history-body">
            <div className="empty-message">
              <p>
                This project owner does
                <br />
                not have any past
                <br />
                projects
      ...
      {openDonateWindow ? (
        <DonationPopup projectData={projectData} closeWindow={closeWindow} />
      ) : (
        <></>
      )}
    </div>
      ...
      <div className="perk-information">
        ...
        <div className="perk-owner">
          <img
            ...
            src={projectData.ownerProfilePic}
            alt="project owner picture"
          />
...
const DonationPopup: React.FC<PopupWindowProps> = ({
  projectData,
  closeWindow,
}) => {
  return (
        ...
        <div className="donation-content-container">
          <div className="donation-content">
            <div>
              ...
              <p className="donation-form-text center-text">
                Use the form below to make your donation to the <br />{" "}
                <span>{projectData.projectName}</span> <br /> project
              </p>
            </div>
            <div className="donation-amounts">
              <input
                className="donation-amount-bar"
                type="number"
                name=""
                id=""
            ...
            <div className="donation-button-popup">
              <button className="donate-button project-button">
                <p>DONATE NOW!</p>
                <img src="/Donate Icon.svg" alt="donate icon" />
              </button>
            </div>
