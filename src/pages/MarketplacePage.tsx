...
const Marketplace: React.FC<{}> = () => {
    const marketplaceNFTData = [
        ...
        {title: "Brick-and-morter Travels", price: "0.45", image: "/Tracking2x.png"},
        ...
        <div className="marketplace-page">
            ...
            <div className="marketplace-main-content">
                ...
                <div className="marketplace-content-filter-buttons">
                    <button className="marketplace-content-filters-button active">All</button>
                    <button className="marketplace-content-filters-button">Trending</button>
                    <button className="marketplace-content-filters-button">Collectibles</button>
                    <button className="marketplace-content-filters-button">Domain Names</button>
                    <button className="marketplace-content-filters-button">Music</button>
                    <button className="marketplace-content-filters-button">Photography</button>
                </div>
                <div className="marketplace-content-filter-buttons">
                    <button className="marketplace-content-filters-button">Apply Filter</button>
                    <button className="marketplace-content-filters-button">Sort By</button>
                </div>
                    </div>
                    <div className="marketplace-grid">
                {marketplaceNFTData.map((item, index) => (
                    <MarketplaceNFTCard key={index} title={item.title} price={item.price} image={item.image} />
                ))}
                    </div>
                </div>
            </div>
