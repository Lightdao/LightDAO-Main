...
const NewListing: React.FC<{}> = () => {
    ...
    const [data, setData] = useState<NftMetaData>({ name: "", description: "", properties: "", price: 0.0, royalties: 0.0, collection: "" });
    ...
    switch (stepNumber) {
        ...
        case 2:
            return <NewListingsStep3 incrementStepNumber={incrementStepNumber} decrementStepNumber={decrementStepNumber} imagePreviewUrl={imagePreviewUrl} handleImageChange={handleImageChange} data={data} selectedImage={selectedImage} />;
        case 3:
            return <NewListingsStep4 incrementStepNumber={incrementStepNumber} decrementStepNumber={decrementStepNumber} data={data} handleInputChange={handleInputChange} />;
        case 4:
            return <NewListingsStep5  incrementStepNumber={incrementStepNumber} decrementStepNumber={decrementStepNumber} data={data} handleInputChange={handleInputChange} />;
        case 5:
            return <NewListingsStep6  incrementStepNumber={incrementStepNumber} decrementStepNumber={decrementStepNumber} />;
        case 6:
            return <NewListingsStep7 selectedImage={selectedImage} imagePreviewUrl={imagePreviewUrl} data={data} />;
    }
