        ...
        <div className="main-dashboard">
            ...
            <div className="main-dashboard-content">
                ...
                <div className="main-dashboard-grid">
                    <DashboardCard name={"Overview"} value={"$96.4k"} metric={"Total volume"} percentageGain={+10}/>
                    <DashboardCard name={"Performance"} value={"4.950"} metric={"Transactions"} percentageGain={+8}/>
                    <DashboardCard name={"Conversion"} value={"2.148"} metric={"Sales"} percentageGain={+2}/>
