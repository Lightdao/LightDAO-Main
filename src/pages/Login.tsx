  ...
  return (
    <div className="container">
      <div className="left-pane">
        <h1>
          A highly-curated platform for creating, collecting unique Faith Driven
          NFTs
        </h1>
        <div className="image-circles">
          ...
          <div
            className="circle"
            style={{ backgroundImage: "url(/path/to/image5.jpg)" }}
          ></div>
          <div
            className="circle"
            style={{ backgroundImage: "url(/path/to/image6.jpg)" }}
          ></div>
          <div
            className="circle"
            style={{ backgroundImage: "url(/path/to/image7.jpg)" }}
          ></div>
        </div>
      </div>
