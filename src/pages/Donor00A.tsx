...
const ActivityFeed: React.FC<{}> = () => {
  ...
  const tableElements = tableList.map((item) => (
    <div className="table-rows" key={item.id}>
      ...
      <div className="activity-cell">
        <div className="download-opentab">
          <button>
            <img src={item.openNewTab ? "/open_new_tab.svg" : ""} alt="" />
          </button>{" "}
          <button>
            <img src={item.download ? "/download.svg" : ""} alt="" />
          </button>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="dashboard">
      <section>
        ...
        <h1>Dashboard</h1>
        <p>
          Here, you can see quick stats on your donations, Recommended projects,
          project updates, NFTs collected, and many more...
        </p>
        <div className="donor-cards">
          <div className="donor-card">
            <p className="title green-text">
              <img src="/money.svg" alt="money icon" /> Total Donation Amount
            </p>
            <h2 className="green-text">$5,000</h2>
            <p className="small-card-text">donated so far</p>
            <a className="green-text" href="/">
              View Donations Breakdown
            </a>{" "}
          ...
          <div className="donor-card">
            <p className="title blue-text">
              <img
                src="/Number of Donations Made.svg"
                alt="number of donations icon"
              />{" "}
              Number of Donations
            </p>
          ...
          <div className="donor-card">
            <p className="title yellow-text">
              <img src="/Projects Icon.png" alt="project icon" /> Projects
              Supported
            </p>
          ...
          <div className="donor-card">
            <p className="title purple-text">
              <img
                src="/Average Donation Icon.svg"
                alt="average donation icon"
              />{" "}
              Average Donation
            </p>
          ...
          <div className="donor-card">
            <p className="title pink-text">
              <img
                src="/Largest Donation Icon.svg"
                alt="largest donation icon"
              />{" "}
              Largest Donation
            </p>
          ...
          <div className="donor-card">
            <p className="title orange-text">
              <img src="/flag.svg" alt="flag" /> Impact Assessment
            </p>
            <h2 className="orange-text">5</h2>
            <p className="small-card-text">
              projects goals you helped accomplish
            </p>
          ...
          <div className="donor-card">
            <p className="title dark-blue-text">
              <img src="/NFT Icon.svg" alt="nft icon" /> NFTs Received
            </p>
            <h2 className="dark-blue-text">40</h2>
            <p className="small-card-text">Collectibles: 25 | Utilities: 15</p>
            <a className="dark-blue-text" href="/">
              View All Your NFTs
            </a>{" "}
            <span className="dark-blue-text">&gt;</span>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <p>
          A curated list of projects on your recent preferences and donations
      ...
      <section>
        <h2>Activity Feed</h2>
        <p>
          Shows a list of recent activities surrounding donations, projects, and
          NFT receipts
        </p>
